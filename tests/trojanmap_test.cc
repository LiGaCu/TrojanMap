...
TEST(TrojanMapTest, Autocomplete) {
  ...
  std::vector<std::string> gt1 = {"Chipotle Mexican Grill","ChickfilA"}; // groundtruth for "Ch"
  EXPECT_EQ(names, gt1);
  // Test the lower case
  names = m.Autocomplete("ch");
  std::vector<std::string> gt2 = {"Chipotle Mexican Grill","ChickfilA"}; // groundtruth for "ch"
  EXPECT_EQ(names, gt2);
  // Test the lower and upper case 
  names = m.Autocomplete("cH"); 
  std::vector<std::string> gt3 = {"Chipotle Mexican Grill","ChickfilA"}; // groundtruth for "cH"
  EXPECT_EQ(names, gt3);
}
